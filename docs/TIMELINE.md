...
```mermaid
timeline
  title Mistwood build path
  2025-08-24 : Flipped WS port to **4102**; verified in portal log and `ss -ltnp`.
  : Created `/home/atlantis/dev/mistwood-dev-dev/ws_smoke.py` and connected successfully.
