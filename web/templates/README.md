...
markers in them to allow Mistwood/Django to insert dynamic content in a web
...
You can replace Mistwood's default templates by overriding them in this folder.
