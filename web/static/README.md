...
Mistwood server. This is usually CSS and Javascript files but you _could_ also
...
You can also override default Mistwood files from here. The original files are
...
Note that all static resources will be collected from all over Mistwood into
